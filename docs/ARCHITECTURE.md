...
### Ingestion (offline)
1. **Source**: `knowledge_base/` (latest help-center export; see `docs/HELP_CORPUS.md`; falls back to `clockify_help_corpus.en.md` then `knowledge_full.md`).
...
- **Input**: `knowledge_base/` (primary help corpus; fallbacks: `clockify_help_corpus.en.md`, then legacy `knowledge_full.md`).
