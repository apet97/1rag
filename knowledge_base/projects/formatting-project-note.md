---
title: "Format project note"
url: "https://clockify.me/help/projects/formatting-project-note"
category: "projects"
...
* [Headings and links](#headings-and-links)
...
You can format text in project note using [markdown](https://en.wikipedia.org/wiki/Markdown). So for example, if you wish to make a heading, you add \# at the start of the row, like this \#\# Heading 2\. Or, if you wish to bold some word, you need to surround the word with two asterisks, like this: \*\*bolded word\*\*.
...
![](https://clockify.me/help/wp-content/uploads/2024/03/Screenshot-2024-03-20-at-16.27.04-949x1024.png)
