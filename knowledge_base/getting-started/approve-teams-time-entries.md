...
* [Bulk approve/reject time entries](#bulk-approve-reject-time-entries)
...
1. In the **Approvals** page, go to the **Pending** tab to see all time entries awaiting approval
...
You can quickly approve multiple pending timesheets and expenses from the **Approval** page.

### Steps to perform bulk action:  [\#](#steps-to-perform-bulk-action)
...
If you click **Reject**, a pop\-up will appear requiring you to add a rejection note before confirming.
...
When you reject a time entry, it will be deleted from the approval list, and the user will receive an email notification explaining the reason for rejection. The entry will get a **Rejected** label and moved to the **Archive** tab. 
