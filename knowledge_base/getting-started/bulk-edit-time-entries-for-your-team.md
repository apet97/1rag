---
title: "Bulk edit time entries for your team"
url: "https://clockify.me/help/getting-started/bulk-edit-time-entries-for-your-team"
category: "getting-started"
slug: "bulk-edit-time-entries-for-your-team"
---
...
### Bulk submit timesheet for others [\#](#bulk-submit-timesheet-for-others)

As a team manager you can submit multiple unsubmitted timesheets from other users at once and improve the approval process.

To bulk submit timesheets for others:

1. Go to the **Approval** page and choose the **Unsubmitted** tab
2. Check the boxes next to the timesheets you’d like to submit
3. Click the checkbox at the top of the column to select all timesheets in that submission period.
4. Click **Submit**

### Bulk approve/reject timesheets [\#](#bulk-approve-reject-timesheets)

As a project manager, you can quickly approve multiple pending timesheets and expenses from the **Approval** page.
