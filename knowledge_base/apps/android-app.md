...
* [Reports](#reports)
* [Receive reminders and notifications](#receive-reminders-and-notifications)
...
Clockify groups similar time entries under one expandable entry. 

If you wish to see entries in chronological order, go to **Profile settings** \> **Preferences** in the web app and turn off **Group similar time entries**.
...
![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-10-at-12.05.41-474x1024.png)

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-10-at-12.06.46-476x1024.png)

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-10-at-12.08.18-476x1024.png)
...
On the **Time tracker** screen, in the **List** tab, when you tap the three little dots in the time entry card you’ll find more options:
...
You can also do any of these actions on swipe:

* Continue time entry (swipe right)
* Duplicate time entry (swipe right)
* Delete time entry (swipe left)

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-17-at-15.10.07-479x1024.png)

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-17-at-15.12.03-478x1024.png)

### Split entry [\#](#split-entry)

Split entry option is available to all users on all paid plans and Free trial. 

Split a time or break entry into smaller segments on the **Time tracker** or **Calendar** pages.

1. Find the entry you want to split on the **Time tracke**r or **Calendar** page
2. Tap on the **three\-dots** menu
3. Choose the **Split** entry option and time where you want to split the entry option

![](https://clockify.me/help/wp-content/uploads/2020/06/image-1.png)
...
![](https://clockify.me/help/wp-content/uploads/2020/06/image.png)
For time entries shorter than 2 minutes, you will receive a message that the entry is too short to split and won’t be able to split it.  
...
![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-10-at-12.14.16-478x1024.png)
**Discarded entry**
...
Pomodoro timer helps you structure your work by breaking it into **focus sessions** (work) and **break sessions**. That way, you can stay focused and productive. 

### Use Pomodoro [\#](#use-pomodoro)

To use Pomodoro: 

1. Go to the **Time tracker** screen
2. Tap on the **Pomodoro** tab
3. Tap Start session to begin your focus session

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-10-at-11.43.55-478x1024.png)
If you have [required fields](https://clockify.me/help/track-time-and-expenses/required-fields), the Edit focus details screen will appear first. 

### Customize Pomodoro [\#](#customize-pomodoro)

Set up Pomodoro timer to match your preferences in the Pomodoro settings: 

* **Set intervals**Define the duration of your focus session (default 25 min) and your break session (default 5 min)
* **Default break project**Choose a specific project for break time entries, regardless of your workspace defaults
* **Automatic break**Toggle it ON or OFF

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-10-at-11.51.26.png)
If the Automatic break option is **on**, the focus session ends and the break starts immediately.   
If the Automatic break option is **off**, you receive a notification and need to manually tap Start to begin the break session. 

### Notifications [\#](#notifications)

You’ll receive push notifications when it’s time to start or end a session. You can even start a break directly from the notification. 

If you want to stop the session early while it’s still running, you’ll be notified that the Pomodoro session will finish earlier than expected before confirming the action. 

Use **Skip the break** **manually** option during a break session to immediately begin a new focus session. 

### Important to note  [\#](#important-to-note)

* When a Pomodoro session is active, the timer appears in your regular list view like any other entry
* You cannot run the regular timer and the Pomodoro timer simultaneously

If you close Clockify while the session is active, the system will save the time entry for the predefined session duration. When you reopen the app, then countdown will resume if the session is still active. 
...
![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-11-10-at-12.23.47-473x1024.png)
...
Configure your push notifications to receive alerts to start or stop your timer, and stay informed about important team updates, like time off requests.
...
You will be asked for the permission to receive notifications after you initially log into the app.

### Notification settings [\#](#notification-settings)

You can customize which notifications you receive:

1. Open the main menu and go to **Workspace** tab
2. Tap on **Notifications**
3. Here, you can enable the type of notifications you want to receive:
	1. Time off: alerts for time off requests
	2. Scheduling: alerts about scheduling changes

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-10-23-at-11.22.15.png)
Essential notifications (e.g. start/stop reminders, approvals) are turned on by default. You can change these settings at any time. If you are in offline mode, your notification will be disabled.

### Timer reminders [\#](#timer-reminders)
...
![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-10-23-at-11.28.50.png)
3. In the **Set reminders** window you can:
	1. Set reminders to **start** tracking at specific times
	2. Set reminders to **stop** tracking at specific times  
	![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-10-23-at-11.26.07.png)
4. Tap **Save**
...
To stop receiving all reminders, go to **Settings** \> **Reminders** and toggle the switch off. 

### Time off indicator [\#](#time-off-indicator)

If you’re a Manager/Admin/Owner, a time off indicator helps you quickly see when new requests are pending.  
You’ll see a **badge icon** on the main menu, which alerts you to pending notifications, even when you’re on the home screen.

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-10-23-at-11.36.13-468x1024.png)
The indicator disappears as soon as the request is **approved, rejected, or withdrawn.**
...
Tap the three horizontal lines located in the upper left\-hand corner and select Settings.

In the **App** tab you can:
...
* [Enable time tracking reminders](https://clockify.me/help/apps/android-app#receive-reminders-and-notifications)
* Choose preferred date format
* Switch between 12\-hour and 24\-hour format
* [Set](https://clockify.me/help/apps/android-app#week-start) [day start](https://clockify.me/help/apps/android-app#day-start)
...
Use **Workspace** tab to:

* [Configure notifications](https://clockify.me/help/apps/android-app#notification-settings)
...
![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-10-23-at-12.18.49-472x1024.png)

![](https://clockify.me/help/wp-content/uploads/2020/06/Screenshot-2025-10-23-at-12.20.06-478x1024.png)
