---
title: "Clockify notifications in Pumble app"
url: "https://clockify.me/help/integrations/clockify-notifications-in-pumble-app"
category: "integrations"
slug: "clockify-notifications-in-pumble-app"
---
...
### Approve, reject, withdraw time off request [\#](#approve-reject-withdraw-time-off-request)

Managers and admins can **approve**, **reject** or **withdraw** requests submitted in Clockify directly from Pumble messages they receive with user’s name, requested date range and **Approve** and **Reject** options. 

![](https://clockify.me/help/wp-content/uploads/2025/07/approve_time_off.png)
After the approval or rejection, the request is processed immediately and the employee who made the request is notified of the decision, as well. 
