...
│   └── clockify_help_corpus.en.md   ← Clockify/CAKE docs (UpdateHelpGPT export; fallback: knowledge_full.md)
│
...
- **Regenerable**: Yes (from clockify_help_corpus.en.md)
...
┌─────────────────┐
│ clockify_help   │  (UpdateHelpGPT export)
│ corpus.en.md    │
└────────┬────────┘
         │
...
| clockify_help_corpus.en.md | ~7 MB | No | No (source data; legacy knowledge_full.md supported) |
...
│
└── File System
    ├── Input: clockify_help_corpus.en.md
...
chmod 644 clockify_help_corpus.en.md
```
